...
namespace calculator
{
   ...
   struct operators
   {
      operators()
      {
         ...
         insert( "**", order( 4 ), []( const double l, const double r ) { return std::pow(l, r); } );
         insert( "*", order( 5 ), []( const double l, const double r ) { return l * r; } );
         insert( "/", order( 5 ), []( const double l, const double r ) { return l / r; } );
         //insert( "%", order( 5 ), []( const double l, const double r ) { return l % r; } );
         insert( "+", order( 6 ), []( const double l, const double r ) { return l + r; } );
         insert( "-", order( 6 ), []( const double l, const double r ) { return l - r; } );
         //insert( "<<", order( 7 ), []( const double l, const double r ) { return l << r; } );
         //insert( ">>", order( 7 ), []( const double l, const double r ) { return l >> r; } );
         insert( "<", order( 8 ), []( const double l, const double r ) { return l < r; } );
         insert( ">", order( 8 ), []( const double l, const double r ) { return l > r; } );
         insert( "<=", order( 8 ), []( const double l, const double r ) { return l <= r; } );
         insert( ">=", order( 8 ), []( const double l, const double r ) { return l >= r; } );
         insert( "==", order( 9 ), []( const double l, const double r ) { return l == r; } );
         insert( "!=", order( 9 ), []( const double l, const double r ) { return l != r; } );
         //insert( "&", order( 10 ), []( const double l, const double r ) { return l & r; } );
         //insert( "^", order( 11 ), []( const double l, const double r ) { return l ^ r; } );
         //insert( "|", order( 12 ), []( const double l, const double r ) { return l | r; } );
         //insert( "&&", order( 13 ), []( const double l, const double r ) { return ( ( l != 0 ) && ( r != 0 ) ) ? 1 : 0; } );
         //insert( "||", order( 14 ), []( const double l, const double r ) { return ( ( l != 0 ) || ( r != 0 ) ) ? 1 : 0; } );
      }
   ...
   struct number
     : seq< opt< one< '+', '-' > >, plus< digit >, opt < one<'.'>, plus<digit>>>
   {};
