...
struct Color final {
  ...
  static Color from_proto(const color::Rgba& proto);
  static void from_proto(const color::Rgba& proto, Color* color);
  static color::Rgba to_proto(const Color& color);
  static void to_proto(const Color& color, color::Rgba* proto);
};
