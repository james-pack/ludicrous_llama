...
void Material::from_proto(const material::proto::Material& proto, Material* material) {
...
Material Material::from_proto(const material::proto::Material& proto) {
  Material material{};
  from_proto(proto, &material);
  return material;
}

void Material::to_proto(const Material& material, material::proto::Material* proto) {
...
material::proto::Material Material::to_proto(const Material& material) {
