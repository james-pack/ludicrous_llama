...
void Orientation::from_proto(const component::Orientation& proto, Orientation* orientation) {
  orientation->orientation[0] = proto.rot_x();
  orientation->orientation[1] = proto.rot_y();
  orientation->orientation[2] = proto.rot_z();
}

Orientation Orientation::from_proto(const component::Orientation& proto) {
  Orientation result{};
  from_proto(proto, &result);
  return result;
}

void Orientation::to_proto(const Orientation& orientation, component::Orientation* proto) {
...
component::Orientation Orientation::to_proto(const Orientation& orientation) {
  component::Orientation proto{};
...
void Position::from_proto(const component::Position& proto, Position* position) {
...
Position Position::from_proto(const component::Position& proto) {
  Position result{};
  from_proto(proto, &result);
  return result;
}

void Position::to_proto(const Position& position, component::Position* proto) {
...
component::Position Position::to_proto(const Position& position) {
  component::Position proto{};
