...
void Colors::to_array(const proto::Rgba& color, float* values) {
  ...
  switch (color.color_representation_case()) {
    case proto::Rgba::ColorRepresentationCase::kFloatValues: {
    ...
    case proto::Rgba::ColorRepresentationCase::kIntValues: {
    ...
    case proto::Rgba::ColorRepresentationCase::kUint32Values: {
...
void Colors::from_array(const float* values, proto::Rgba* color) {
...
proto::Rgba Colors::as_floats(const proto::Rgba& color) {
...
proto::Rgba Colors::as_ints(const proto::Rgba& color) {
...
proto::Rgba Colors::as_uint32s(const proto::Rgba& color) {
